...
export const portfolioConfig = {
  ...
  skills: {
    ...
    frameworksBackend: [
      ...
      {
        name: "Nest.js",
        icon: "https://homepage-media.s3.ap-southeast-1.amazonaws.com/wp-content/uploads/2020/07/28093657/nestjs.png",
      },
    ],
    tools: [
      {
      ...
      {
        name: "Subparbase",
        icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCjnyHsUwEeCd4dnjiUwXjV6d9k_vEiC6hIA&s",
      },
      {
        name: "My SQL",
  ...
  developmentPractices: [
    {
      name: "Agile",
      icon: "https://aguayo-co.s3.amazonaws.com/public/images/Agile-methodology-user-experience.width-490.png",
    },
    {
      name: "Scrum",
      icon: "https://truyenthongtms.com/wp-content/uploads/2021/09/mo-hinh-scrum-la-gi-1.png",
    },
  ],
